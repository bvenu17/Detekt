 ...
 * {@link com.google.android.gms.samples.vision.ocrreader.ui.camera.CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSource {
    ...
    public static class Builder {
        ...
        private com.google.android.gms.samples.vision.ocrreader.ui.camera.CameraSource mCameraSource = new com.google.android.gms.samples.vision.ocrreader.ui.camera.CameraSource();
         ...
         */
        public com.google.android.gms.samples.vision.ocrreader.ui.camera.CameraSource build() {
    ...
    public com.google.android.gms.samples.vision.ocrreader.ui.camera.CameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public com.google.android.gms.samples.vision.ocrreader.ui.camera.CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
